...
namespace KIP_server_NoAuth.V1.Controllers
{
    ...
    public class AudienceScheduleController : Controller
    {
        ...
        public AudienceScheduleController(ILogger<AudienceScheduleController> logger, KIPDbContext context)
        {
        ...
        {
            var info = $"{nameof(KIP_Backend.Models.KIP.NoAuth.AudienceSchedule)}";
            return this.Ok(info);
        }
