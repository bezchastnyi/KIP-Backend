...
namespace KIP_Backend.Attributes
{
    ...
    public class V1_1Attribute : ApiVersionAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1_1Attribute"/> class.
        /// </summary>
        public V1_1Attribute()
            : base(new ApiVersion(1, 1))
        { }
    }
}
